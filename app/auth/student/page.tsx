      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">Join BrainBuddy to start your learning journey</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setFormData({ ...formData, isIntern: checked as boolean })}
                    />
                    <Label htmlFor="intern" className="text-sm">
                      I have passed out and looking for internships
                    </Label>
                  </div>
                  <Button
                    type="submit"
